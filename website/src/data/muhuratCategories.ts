// Client-side mirror of mobile — category grid + dynamic form fields.

export type Bi = { en: string; hi: string }
export type FieldReq = 'none' | 'optional' | 'required'
export interface MuhuratReq {
  name: FieldReq
  birth: FieldReq
  couple: boolean
}
...
export const MUHURAT_GROUPS: MuhuratGroup[] = [
  {
    key: 'property',
    title: b('Property & Home', 'संपत्ति व घर'),
    items: [
  ...
  {
    key: 'family',
    title: b('Marriage & Family', 'विवाह व परिवार'),
    items: [
  ...
  {
    key: 'career',
    title: b('Business & Career', 'व्यापार व करियर'),
    items: [
