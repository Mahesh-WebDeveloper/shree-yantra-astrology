...
export const VEDA_CONFIG: Record<string, VedaConfig> = {
  ...
  "puran-narada": { key: "puran-narada", title: { en: "Narada Purana", hi: "नारद पुराण" }, subtitle: { en: "Sanskrit · 2 Bhaga · 195 chapters", hi: "संस्कृत · 2 भाग · 195 अध्याय" }, bookLabel: { en: "Bhaga", hi: "भाग" }, sectionLabel: { en: "Adhyaya", hi: "अध्याय" }, verseLabel: { en: "Shloka", hi: "श्लोक" }, hasSections: true },
