...
export function ShreeYantraLogo({ size = 80, dark = true }: { size?: number; dark?: boolean }) {
  const s = 'url(#syg)';
  return (
    <Svg width={size} height={size} viewBox="0 0 200 200" fill="none">
      <Gold id="syg" dark={dark} />
      {!dark && <Circle cx={100} cy={100} r={94} fill="#ffffff" opacity={0.78} />}
      <Rect x={14} y={14} width={172} height={172} stroke={s} strokeWidth={dark ? 2 : 3} fill="none" />
      <Rect x={20} y={20} width={160} height={160} stroke={s} strokeWidth={dark ? 1 : 1.8} fill="none" opacity={dark ? 0.7 : 0.95} />
      <G stroke={s} strokeWidth={dark ? 1.5 : 2.2}>
      ...
      <Path d="M85 14 L100 2 L115 14" stroke={s} strokeWidth={dark ? 2 : 3} fill="none" />
      <Path d="M85 186 L100 198 L115 186" stroke={s} strokeWidth={dark ? 2 : 3} fill="none" />
      <Path d="M14 85 L2 100 L14 115" stroke={s} strokeWidth={dark ? 2 : 3} fill="none" />
      <Path d="M186 85 L198 100 L186 115" stroke={s} strokeWidth={dark ? 2 : 3} fill="none" />
      <Circle cx={100} cy={100} r={74} stroke={s} strokeWidth={dark ? 1.2 : 2} fill="none" />
      <Circle cx={100} cy={100} r={60} stroke={s} strokeWidth={dark ? 1.2 : 2} fill="none" />
      <G stroke={s} strokeWidth={dark ? 1.4 : 2.2} fill="none">
...
export function ZodiacWheel({ size = 120, dark = true }: { size?: number; dark?: boolean }) {
  ...
  const spokes = Array.from({ length: 12 }).map((_, i) => {
    ...
    return <Line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke={s} strokeWidth={dark ? 0.7 : 1.2} opacity={dark ? 0.6 : 0.92} />;
  });
  return (
    <Svg width={size} height={size} viewBox="0 0 200 200">
      ...
      <Circle cx={100} cy={100} r={58} fill="none" stroke={s} strokeWidth={dark ? 0.8 : 1.4} opacity={dark ? 0.7 : 0.95} />
      {spokes}
      <SvgText x={100} y={128} textAnchor="middle" fontSize={78} fontWeight={dark ? '400' : '800'} fill={s}>♌</SvgText>
    </Svg>
  );
}

/* ───── Feature: Daily Prediction (sun) ───── */
export function SunArt({ size = 80, dark = true }: { size?: number; dark?: boolean }) {
  const s = 'url(#sg)';
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 200 200">
      <Gold id="sg" dark={dark} />
      {!dark && <Circle cx={100} cy={100} r={94} fill="#ffffff" opacity={0.78} />}
      <Circle cx={100} cy={100} r={96} fill="none" stroke={s} strokeWidth={dark ? 1.5 : 2.3} />
      <Circle cx={100} cy={100} r={80} fill="none" stroke={s} strokeWidth={dark ? 0.8 : 1.5} opacity={dark ? 0.7 : 0.95} />
      <Circle cx={100} cy={100} r={56} fill="none" stroke={s} strokeWidth={dark ? 0.8 : 1.5} opacity={dark ? 0.7 : 0.95} />
      {rays}
...
export function KundliArt({ size = 80, dark = true }: { size?: number; dark?: boolean }) {
  const s = 'url(#kg)';
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 200 200">
      <Gold id="kg" dark={dark} />
      {!dark && <Rect x={16} y={16} width={168} height={168} rx={8} fill="#ffffff" opacity={0.82} />}
      <Rect x={20} y={20} width={160} height={160} stroke={s} strokeWidth={dark ? 1.8 : 2.6} fill="none" />
      <Line x1={20} y1={20} x2={180} y2={180} stroke={s} strokeWidth={dark ? 1.4 : 2} />
      <Line x1={180} y1={20} x2={20} y2={180} stroke={s} strokeWidth={dark ? 1.4 : 2} />
      <Line x1={100} y1={20} x2={180} y2={100} stroke={s} strokeWidth={dark ? 1.4 : 2} />
      <Line x1={180} y1={100} x2={100} y2={180} stroke={s} strokeWidth={dark ? 1.4 : 2} />
      <Line x1={100} y1={180} x2={20} y2={100} stroke={s} strokeWidth={dark ? 1.4 : 2} />
      <Line x1={20} y1={100} x2={100} y2={20} stroke={s} strokeWidth={dark ? 1.4 : 2} />
      {houses.map(([x, y, n]) => (
...
export function DiyaArt({ size = 80, dark = true }: { size?: number; dark?: boolean }) {
  const s = 'url(#dg)';
  return (
    <Svg width={size} height={size} viewBox="0 0 200 200">
      <Gold id="dg" dark={dark} />
...
export function StarOrb({ size = 50, dark = true }: { size?: number; dark?: boolean }) {
  const s = 'url(#pbg)';
  return (
    <Svg width={size} height={size} viewBox="0 0 72 72">
      <Gold id="pbg" dark={dark} />
      {!dark && <Circle cx={36} cy={36} r={32} fill="#ffffff" opacity={0.9} />}
      <Circle cx={36} cy={36} r={31} fill="none" stroke={s} strokeWidth={dark ? 1.3 : 2.1} />
      <Circle cx={36} cy={36} r={21} fill="none" stroke={s} strokeWidth={dark ? 1 : 1.5} opacity={dark ? 0.65 : 0.95} />
      <Path d="M36 12l5.2 15.4h16.2L44.3 37l5.1 15.4L36 43l-13.4 9.4L27.7 37 14.6 27.4h16.2z" fill={s} opacity={dark ? 0.9 : 1} />
    </Svg>
  );
}
