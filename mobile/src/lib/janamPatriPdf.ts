...
<section class="pdf-section cover">
  ...
  <section class="pdf-section compact-section"><p class="foot">Computed from real astronomical planetary positions (grahas &amp; nakshatras, Lahiri Ayanamsa) + classical Jyotish · Generated by Shree Yantra App</p></section>
</main></body></html>`;
}
