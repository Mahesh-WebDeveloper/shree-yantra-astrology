...
export const OCCASIONS: Occasion[] = [
  ...
  { id: 'education',    emoji: '📚', hi: 'विद्या आरंभ',   en: 'Education',      subHi: 'पढ़ाई/अक्षर आरंभ पूजा',      subEn: 'Vidyarambh / study',       deityHi: 'माँ सरस्वती व गणेश',          deityEn: 'Saraswati & Ganesha',        accent: '#c9a0e0' },
