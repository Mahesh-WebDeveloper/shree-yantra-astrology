...
const VIVAH: CuratedOccasion = {
  ...
  saptapadi: [
    { hi: 'पहला कदम — अन्न: जीवन में कभी भोजन/पोषण की कमी न हो।', en: 'First step — nourishment: may we never lack food.' },
    { hi: 'दूसरा कदम — बल: शारीरिक व मानसिक स्वास्थ्य बना रहे।', en: 'Second — strength: may we keep physical and mental health.' },
    { hi: 'तीसरा कदम — धन: उचित रीति से धन का उपार्जन हो।', en: 'Third — wealth: may we earn prosperity by righteous means.' },
    { hi: 'चौथा कदम — सुख: परिवार में आत्मिक सुख व शांति रहे।', en: 'Fourth — happiness: may our family have inner joy and peace.' },
    { hi: 'पाँचवाँ कदम — संतान: श्रेष्ठ व संस्कारी संतान की प्राप्ति हो।', en: 'Fifth — progeny: may we be blessed with noble children.' },
    { hi: 'छठा कदम — ऋतुएँ: हर मौसम व परिस्थिति में साथ बना रहे।', en: 'Sixth — seasons: may we stay together through every season.' },
    { hi: 'सातवाँ कदम — मित्रता: दोनों जीवनभर सच्चे मित्र बने रहें।', en: 'Seventh — friendship: may we remain true friends for life.' },
  ],
  mantras: [
    ...
    { title: { hi: 'पाणिग्रहण मंत्र', en: 'Panigrahana mantra' }, sanskrit: 'गृभ्णामि ते सौभगत्वाय हस्तं मया पत्या जरदष्टिर्यथासः।\nभगो अर्यमा सविता पुरन्धिर्मह्यं त्वादुर्गार्हपत्याय देवाः॥', roman: 'Gribhnami te saubhagatvaya hastam maya patya jaradashtir yathasah.\nBhago Aryama Savita Purandhir mahyam tvadur garhapatyaya devah.', meaning: { hi: 'हे वधू! मैं सौभाग्य हेतु तुम्हारा हाथ थाम रहा हूँ, ताकि तुम मेरे साथ वृद्धावस्था तक सुखपूर्वक जियो। भग, अर्यमा, सविता आदि देवों ने गृहस्थ जीवन हेतु तुम्हें मुझे सौंपा है।', en: 'O bride, I take your hand for good fortune, that you may live joyfully with me into old age. The gods Bhaga, Aryama, Savita and others have given you to me to run our household together.' }, when: { hi: 'पाणिग्रहण (हथलेवा) के समय', en: 'At the moment of Panigrahana' } },
